...
(setq var-eq-sinusoidal-period '(calcFunc-eq (var T var-T) (* (/ 1 (var B var-B)) (* 2 (var pi var-pi)))))
(setq var-eq-sinusoidal-frequency '(calcFunc-eq (var f var-f) (/ 1 (var T var-T))))
...
(setq var-eq-simple-compound-interest '(calcFunc-eq (var A var-A) (* (var P var-P) (^ (+ (cplx 1 0) (var r var-r)) (var t var-t)))))
