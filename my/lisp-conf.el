...
(keymap-set emacs-lisp-mode-map "<f1>" 'my/eval-buffer)
...
(eval-after-load 'slime '(progn
                           ...
                           ;; (keymap-set slime-mode-map "C-c C-k" 'slime-compile-file)
                           (keymap-set slime-mode-map "C-c C-k" 'slime-compile-and-load-file)
...
(add-hook 'slime-repl-mode-hook (lambda ()
                                  ...
                                  ;; (keymap-set slime-repl-mode-map "M-/" 'dabbrev-expand)
                                  (keymap-set slime-repl-mode-map "M-/" 'hippie-expand)
