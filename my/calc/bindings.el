...
(with-eval-after-load 'calc
  ...
  (define-key calc-digit-map "n" 'my/calc-insert-pi-from-minibuffer)
...
(use-package calc-ext
  ...
  :bind (;; Unbind
         ...
         (:map calc-mode-map ("a f" . my/calc-factor))
...
(add-hook 'calc-edit-mode-hook
          (lambda ()
            ...
            (keymap-set calc-edit-mode-map "M-l" 'my/calc-edit-square-dwim)
            ...
            (keymap-set calc-edit-mode-map "M-o" 'my/calc-edit-wrap-parens)))
